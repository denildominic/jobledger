...
export default async function ResumeMatchPage({
  ...
  return (
    <section className="container py-10">
      <h1 className="text-3xl font-bold">Resume Match using AI</h1>
      ...
      <div className="mt-6 grid md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
          <h3 className="font-semibold">Tip: Tailor your resume according to the job description.</h3>
